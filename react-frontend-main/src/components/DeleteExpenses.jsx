               ...
               <div className="container">
                   <div className="row">
                      <div className="card col-md-6 offset-md-3 offset-md-3">
                          <h3 className="text-center">Delete Expenses</h3>
                          <div className="card-body">
                              <form>  
                                  <div className="form-group">
                                   ...
                                   <div className="form-group">
                                      <label>Person: </label>
                                      <input placeholder="Person" readOnly= "true" name="person" className="form-control"
                                         value={this.state.person} onChange={this.personHandler} />
                                   </div>   
                                   <div className="form-group">
                                      <label>Category: </label>
                                      <input placeholder="Category" readOnly="true" name="category" className="form-control"
                                         value={this.state.category} onChange={this.categoryHandler} />
                                   </div>   
                                   <div className="form-group">
                                      <label>Amount: </label>
                                      <input placeholder="Amount" readOnly="true" name="amount" className="form-control"
                                   ...
                                   <div className="form-group">
                                      <label>Type: </label>
                                      <input placeholder="Type" readOnly="true" name="type" className="form-control"
